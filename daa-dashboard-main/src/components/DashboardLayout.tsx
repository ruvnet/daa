...
import McpToolsDebugger from './McpToolsDebugger';
...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  const [mcpDebuggerOpen, setMcpDebuggerOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="border-t border-green-500/20 pt-2 mt-2">
                        <Button 
                          ...
                          size="sm" 
                          onClick={() => {
                            setMcpDebuggerOpen(true);
                            setSettingsOpen(false);
                          }}
                          className="w-full justify-start text-green-400/70 hover:text-green-400 text-xs"
                        >
      ...
      {/* MCP Tools Debugger */}
      <McpToolsDebugger 
        isOpen={mcpDebuggerOpen} 
        onClose={() => setMcpDebuggerOpen(false)} 
      />
    </div>
  );
};
