...
if ((command === 'issue' || command === 'pr') && 
  ...
  if (body) {
    ...
    try {
      ...
      // Execute safely using array form to prevent shell injection
    ...
    // No body content, execute normally using array form to prevent shell injection
    execFileSync('gh', args, { stdio: 'inherit' });
  }
} else {
  // Other commands, execute normally using array form to prevent shell injection
  execFileSync('gh', args, { stdio: 'inherit' });
}
